...
module DE2_115_SOPC_mm_interconnect_1 (
	...
	wire   [7:0] lcd_control_slave_agent_m0_address;                                      // lcd_control_slave_agent:m0_address -> lcd_control_slave_translator:uav_address
	...
	wire  [82:0] lcd_control_slave_agent_rf_source_data;                                  // lcd_control_slave_agent:rf_source_data -> lcd_control_slave_agent_rsp_fifo:in_data
	...
	wire  [82:0] lcd_control_slave_agent_rsp_fifo_out_data;                               // lcd_control_slave_agent_rsp_fifo:out_data -> lcd_control_slave_agent:rf_sink_data
	...
	wire  [81:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> lcd_control_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                       // lcd_control_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> lcd_control_slave_agent:cp_channel
	...
	wire  [81:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire  [81:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> sw_s1_agent:cp_data
	...
	wire  [81:0] cmd_mux_005_src_data;                                                    // cmd_mux_005:src_data -> key_s1_agent:cp_data
	...
	wire  [81:0] lcd_control_slave_agent_rp_data;                                         // lcd_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [81:0] led_s1_agent_rp_data;                                                    // led_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [81:0] sw_s1_agent_rp_data;                                                     // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [81:0] key_s1_agent_rp_data;                                                    // key_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [5:0] router_src_channel;                                                      // router:src_channel -> clock_crossing_io_m0_limiter:cmd_sink_channel
	...
	wire   [5:0] clock_crossing_io_m0_limiter_cmd_src_channel;                            // clock_crossing_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [5:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> clock_crossing_io_m0_limiter:rsp_sink_channel
	...
	wire   [5:0] clock_crossing_io_m0_limiter_rsp_src_channel;                            // clock_crossing_io_m0_limiter:rsp_src_channel -> clock_crossing_io_m0_agent:rp_channel
	...
	wire   [5:0] clock_crossing_io_m0_limiter_cmd_valid_data;                             // clock_crossing_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
